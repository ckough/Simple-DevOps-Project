...
At the time of writing this lecture below 2 files are updated. Comment out these lines with <!-- and -->
   ```sh 
...
goto tomcat home directory and Add below users to conf/tomcat-users.xml file
   ```sh
   vi /opt/apache-tomcat-8.5.70/conf/tomcat-users.xml
	<role rolename="manager-gui"/>
	<role rolename="manager-script"/>
	<role rolename="manager-jmx"/>
	<role rolename="manager-status"/>
	<user username="admin" password="Admincod3" roles="manager-gui, manager-script, manager-jmx, manager-status"/>
	<user username="deployer" password="Admincod3" roles="manager-script"/>
	<user username="tomcat" password="Admincod3" roles="manager-gui"/>
   ```
